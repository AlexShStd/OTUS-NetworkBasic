...
```
заменить Свич приветствие 
```
Для перехода в привелегерованый режим нужно ввести команду **енабле**, приветствие изменится на 

```
заменить Свич приветствие привелегерованное
```
